...
#ifndef REWARDSSDK_SWIFT_H
#define REWARDSSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RewardsSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
typedef SWIFT_ENUM(NSInteger, RewardsHeaderStyle, open) {
  RewardsHeaderStyleDiagonal = 0,
  RewardsHeaderStyleRectangular = 1,
};

typedef SWIFT_ENUM(NSInteger, RewardsImageStyle, open) {
  RewardsImageStyleRoundedRect = 0,
  RewardsImageStyleCircular = 1,
};

@protocol RewardsManagerDelegate;
@class NSString;
@class UIViewController;
@class NSURL;
@class CLLocation;
@class RewardsSDKTheme;

SWIFT_CLASS("_TtC10RewardsSDK14RewardsManager")
@interface RewardsManager : NSObject
@property (nonatomic, weak) id <RewardsManagerDelegate> _Nullable delegate;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) RewardsManager * _Nonnull shared;)
+ (RewardsManager * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)initializeWithOrigin:(NSString * _Null_unspecified)origin cardholderId:(NSString * _Null_unspecified)cardholderId uiContext:(UIViewController * _Null_unspecified)uiContext headerTitle:(NSString * _Null_unspecified)headerTitle userProfileName:(NSString * _Nullable)userProfileName userProfileImage:(NSURL * _Nullable)userProfileImage summaryContent:(NSString * _Nullable)summaryContent userCurrentLocation:(CLLocation * _Nullable)userCurrentLocation theme:(RewardsSDKTheme * _Nullable)theme environment:(enum Environment)environment;
- (void)logoutUser;
- (void)addCustomCallbacksWithCallbacks:(NSArray<NSString *> * _Nonnull)callbacks;
- (void)dismissRewardsWithCompletionHandler:(void (^ _Nonnull)(BOOL))completionHandler;
- (void)rewardsDeeplinkWithDeepLinkUrl:(NSURL * _Null_unspecified)deepLinkUrl completionHandler:(void (^ _Nonnull)(BOOL))completionHandler;
@end


SWIFT_PROTOCOL("_TtP10RewardsSDK22RewardsManagerDelegate_")
@protocol RewardsManagerDelegate <NSObject>
- (void)errorOccuredWithError:(NSString * _Nonnull)error reason:(NSString * _Nonnull)reason;
- (void)callbackDetectedWithName:(NSString * _Nonnull)name;
@end

@class UIColor;

SWIFT_CLASS("_TtC10RewardsSDK15RewardsSDKTheme")
@interface RewardsSDKTheme : NSObject
@property (nonatomic, strong) UIColor * _Nonnull headerColor;
@property (nonatomic, strong) UIColor * _Nonnull primaryColor;
@property (nonatomic, strong) UIColor * _Nonnull interactiveColor;
...
@property (nonatomic, copy) NSString * _Nullable lightFontName;
@property (nonatomic) enum RewardsImageStyle logoStyle;
@property (nonatomic) enum RewardsImageStyle profileImageStyle;
@property (nonatomic) enum RewardsHeaderStyle brandDetailsHeaderStyle;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


/// Responsible for handling all delegate callbacks for the underlying session.
SWIFT_CLASS("_TtC10RewardsSDK15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(RewardsSDK)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(RewardsSDK)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(RewardsSDK)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(RewardsSDK)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(RewardsSDK)) <NSURLSessionTaskDelegate>
